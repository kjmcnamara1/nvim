...
return {
  {
    ...
    opts = {
      ...
      custom_highlights = {
        ["@type.builtin"] = { fg = colors.light_cyan },
        ...
        ["@lsp.type.selfKeyword"] = { link = "@lsp.type.selfParameter" },
        ["@lsp.type.enum"] = { fg = colors.light_yellow, link = colors.none },
        ["@lsp.type.lifetime"] = { fg = colors.light_purple },
        ["@lsp.typemod.property.classMember"] = { style = "bold" },
        ["@lsp.typemod.class.builtin"] = { link = "@type.builtin" },
        ["@lsp.typemod.variable.readonly"] = { fg = colors.light_orange },
        ["@lsp.typemod.interface"] = { fg = colors.light_pink },
